...
<head>
    ...
    <title>Manajemen Kamar - NginapKuy Admin</title>
                            ...
                            <tbody>
                                @forelse ($kamars as $kamar)
                                    <tr>
                                        ...
                                        <td>{{ $kamar->tipeKamar->nama_tipe_kamar }}</td>
                                        <td>Rp {{ number_format($kamar->tipeKamar->harga_per_malam, 2, ',', '.') }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="{{ route('admin.kamars.edit', $kamar->id_kamar) }}" class="btn btn-sm btn-warning" title="Edit Kamar">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('admin.kamars.destroy', $kamar->id_kamar) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kamar ini?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger" title="Hapus Kamar">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">Tidak ada kamar yang tersedia.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
