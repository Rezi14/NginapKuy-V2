...
<head>
    ...
    <title>Tambah Fasilitas Baru - NginapKuy Admin</title>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.fasilitas.store') }}" method="POST">
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="Contoh: fas fa-wifi">
                            <div class="form-text">Gunakan kelas Font Awesome (misal: `fas fa-wifi`, `fas fa-tv`).</div>
                        </div> --}}
